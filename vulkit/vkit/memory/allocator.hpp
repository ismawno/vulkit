...
TKIT_CLANGCL_WARNING_IGNORE("-Wunused-parameter")
TKIT_CLANGCL_WARNING_IGNORE("-Wunused-variable")
TKIT_CLANGCL_WARNING_IGNORE("-Wunused-function")
TKIT_CLANGCL_WARNING_IGNORE("-Wmissing-field-initializers")
...
VKIT_NO_DISCARD Result<VmaAllocator> CreateAllocator(const LogicalDevice &device, const AllocatorSpecs &specs = {});
