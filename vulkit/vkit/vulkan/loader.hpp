...
VKIT_API VKIT_LOADER_NO_DISCARD VkResult CreateInstance(const VkInstanceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkInstance* pInstance) noexcept;

extern PFN_vkGetInstanceProcAddr vkGetInstanceProcAddr;
VKIT_API VKIT_LOADER_NO_DISCARD PFN_vkVoidFunction GetInstanceProcAddr(VkInstance instance, const char* pName) noexcept;

#if defined(VKIT_API_VERSION_1_1)
extern PFN_vkEnumerateInstanceVersion vkEnumerateInstanceVersion;
VKIT_API VKIT_LOADER_NO_DISCARD VkResult EnumerateInstanceVersion(uint32_t* pApiVersion) noexcept;
#endif

extern PFN_vkEnumerateInstanceLayerProperties vkEnumerateInstanceLayerProperties;
VKIT_API VKIT_LOADER_NO_DISCARD VkResult EnumerateInstanceLayerProperties(uint32_t* pPropertyCount, VkLayerProperties* pProperties) noexcept;

extern PFN_vkEnumerateInstanceExtensionProperties vkEnumerateInstanceExtensionProperties;
VKIT_API VKIT_LOADER_NO_DISCARD VkResult EnumerateInstanceExtensionProperties(const char* pLayerName, uint32_t* pPropertyCount, VkExtensionProperties* pProperties) noexcept;
...
struct VKIT_API InstanceTable
{
    ...
    VKIT_LOADER_NO_DISCARD VkResult EnumeratePhysicalDevices(VkInstance instance, uint32_t* pPhysicalDeviceCount, VkPhysicalDevice* pPhysicalDevices) const noexcept;
    
    PFN_vkGetDeviceProcAddr vkGetDeviceProcAddr = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD PFN_vkVoidFunction GetDeviceProcAddr(VkDevice device, const char* pName) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceImageFormatProperties(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkImageTiling tiling, VkImageUsageFlags usage, VkImageCreateFlags flags, VkImageFormatProperties* pImageFormatProperties) const noexcept;
    
    PFN_vkCreateDevice vkCreateDevice = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateDevice(VkPhysicalDevice physicalDevice, const VkDeviceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDevice* pDevice) const noexcept;
    
    PFN_vkEnumerateDeviceLayerProperties vkEnumerateDeviceLayerProperties = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult EnumerateDeviceLayerProperties(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkLayerProperties* pProperties) const noexcept;
    
    PFN_vkEnumerateDeviceExtensionProperties vkEnumerateDeviceExtensionProperties = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult EnumerateDeviceExtensionProperties(VkPhysicalDevice physicalDevice, const char* pLayerName, uint32_t* pPropertyCount, VkExtensionProperties* pProperties) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateAndroidSurfaceKHR(VkInstance instance, const VkAndroidSurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    
#if defined(VK_KHR_display)
    PFN_vkGetPhysicalDeviceDisplayPropertiesKHR vkGetPhysicalDeviceDisplayPropertiesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceDisplayPropertiesKHR(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayPropertiesKHR* pProperties) const noexcept;
#endif
    
#if defined(VK_KHR_display)
    PFN_vkGetPhysicalDeviceDisplayPlanePropertiesKHR vkGetPhysicalDeviceDisplayPlanePropertiesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceDisplayPlanePropertiesKHR(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayPlanePropertiesKHR* pProperties) const noexcept;
#endif
    
#if defined(VK_KHR_display)
    PFN_vkGetDisplayPlaneSupportedDisplaysKHR vkGetDisplayPlaneSupportedDisplaysKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetDisplayPlaneSupportedDisplaysKHR(VkPhysicalDevice physicalDevice, uint32_t planeIndex, uint32_t* pDisplayCount, VkDisplayKHR* pDisplays) const noexcept;
#endif
    
#if defined(VK_KHR_display)
    PFN_vkGetDisplayModePropertiesKHR vkGetDisplayModePropertiesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetDisplayModePropertiesKHR(VkPhysicalDevice physicalDevice, VkDisplayKHR display, uint32_t* pPropertyCount, VkDisplayModePropertiesKHR* pProperties) const noexcept;
#endif
    
#if defined(VK_KHR_display)
    PFN_vkCreateDisplayModeKHR vkCreateDisplayModeKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateDisplayModeKHR(VkPhysicalDevice physicalDevice, VkDisplayKHR display, const VkDisplayModeCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDisplayModeKHR* pMode) const noexcept;
#endif
    
#if defined(VK_KHR_display)
    PFN_vkGetDisplayPlaneCapabilitiesKHR vkGetDisplayPlaneCapabilitiesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetDisplayPlaneCapabilitiesKHR(VkPhysicalDevice physicalDevice, VkDisplayModeKHR mode, uint32_t planeIndex, VkDisplayPlaneCapabilitiesKHR* pCapabilities) const noexcept;
#endif
    
#if defined(VK_KHR_display)
    PFN_vkCreateDisplayPlaneSurfaceKHR vkCreateDisplayPlaneSurfaceKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateDisplayPlaneSurfaceKHR(VkInstance instance, const VkDisplaySurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceSurfaceSupportKHR(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, VkSurfaceKHR surface, VkBool32* pSupported) const noexcept;
#endif
    
#if defined(VK_KHR_surface)
    PFN_vkGetPhysicalDeviceSurfaceCapabilitiesKHR vkGetPhysicalDeviceSurfaceCapabilitiesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceSurfaceCapabilitiesKHR(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, VkSurfaceCapabilitiesKHR* pSurfaceCapabilities) const noexcept;
#endif
    
#if defined(VK_KHR_surface)
    PFN_vkGetPhysicalDeviceSurfaceFormatsKHR vkGetPhysicalDeviceSurfaceFormatsKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceSurfaceFormatsKHR(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, uint32_t* pSurfaceFormatCount, VkSurfaceFormatKHR* pSurfaceFormats) const noexcept;
#endif
    
#if defined(VK_KHR_surface)
    PFN_vkGetPhysicalDeviceSurfacePresentModesKHR vkGetPhysicalDeviceSurfacePresentModesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceSurfacePresentModesKHR(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, uint32_t* pPresentModeCount, VkPresentModeKHR* pPresentModes) const noexcept;
#endif
    
#if defined(VK_NN_vi_surface)
    PFN_vkCreateViSurfaceNN vkCreateViSurfaceNN = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateViSurfaceNN(VkInstance instance, const VkViSurfaceCreateInfoNN* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    
#if defined(VK_KHR_wayland_surface)
    PFN_vkCreateWaylandSurfaceKHR vkCreateWaylandSurfaceKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateWaylandSurfaceKHR(VkInstance instance, const VkWaylandSurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    
#if defined(VK_KHR_wayland_surface)
    PFN_vkGetPhysicalDeviceWaylandPresentationSupportKHR vkGetPhysicalDeviceWaylandPresentationSupportKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkBool32 GetPhysicalDeviceWaylandPresentationSupportKHR(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, struct wl_display* display) const noexcept;
#endif
    
#if defined(VK_KHR_win32_surface)
    PFN_vkCreateWin32SurfaceKHR vkCreateWin32SurfaceKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateWin32SurfaceKHR(VkInstance instance, const VkWin32SurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    
#if defined(VK_KHR_win32_surface)
    PFN_vkGetPhysicalDeviceWin32PresentationSupportKHR vkGetPhysicalDeviceWin32PresentationSupportKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkBool32 GetPhysicalDeviceWin32PresentationSupportKHR(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex) const noexcept;
#endif
    
#if defined(VK_KHR_xlib_surface)
    PFN_vkCreateXlibSurfaceKHR vkCreateXlibSurfaceKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateXlibSurfaceKHR(VkInstance instance, const VkXlibSurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    
#if defined(VK_KHR_xlib_surface)
    PFN_vkGetPhysicalDeviceXlibPresentationSupportKHR vkGetPhysicalDeviceXlibPresentationSupportKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkBool32 GetPhysicalDeviceXlibPresentationSupportKHR(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, Display* dpy, VisualID visualID) const noexcept;
#endif
    
#if defined(VK_KHR_xcb_surface)
    PFN_vkCreateXcbSurfaceKHR vkCreateXcbSurfaceKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateXcbSurfaceKHR(VkInstance instance, const VkXcbSurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    
#if defined(VK_KHR_xcb_surface)
    PFN_vkGetPhysicalDeviceXcbPresentationSupportKHR vkGetPhysicalDeviceXcbPresentationSupportKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkBool32 GetPhysicalDeviceXcbPresentationSupportKHR(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, xcb_connection_t* connection, xcb_visualid_t visual_id) const noexcept;
#endif
    
#if defined(VK_EXT_directfb_surface)
    PFN_vkCreateDirectFBSurfaceEXT vkCreateDirectFBSurfaceEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateDirectFBSurfaceEXT(VkInstance instance, const VkDirectFBSurfaceCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    
#if defined(VK_EXT_directfb_surface)
    PFN_vkGetPhysicalDeviceDirectFBPresentationSupportEXT vkGetPhysicalDeviceDirectFBPresentationSupportEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkBool32 GetPhysicalDeviceDirectFBPresentationSupportEXT(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, IDirectFB* dfb) const noexcept;
#endif
    
#if defined(VK_FUCHSIA_imagepipe_surface)
    PFN_vkCreateImagePipeSurfaceFUCHSIA vkCreateImagePipeSurfaceFUCHSIA = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateImagePipeSurfaceFUCHSIA(VkInstance instance, const VkImagePipeSurfaceCreateInfoFUCHSIA* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    
#if defined(VK_GGP_stream_descriptor_surface)
    PFN_vkCreateStreamDescriptorSurfaceGGP vkCreateStreamDescriptorSurfaceGGP = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateStreamDescriptorSurfaceGGP(VkInstance instance, const VkStreamDescriptorSurfaceCreateInfoGGP* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    
#if defined(VK_QNX_screen_surface)
    PFN_vkCreateScreenSurfaceQNX vkCreateScreenSurfaceQNX = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateScreenSurfaceQNX(VkInstance instance, const VkScreenSurfaceCreateInfoQNX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    
#if defined(VK_QNX_screen_surface)
    PFN_vkGetPhysicalDeviceScreenPresentationSupportQNX vkGetPhysicalDeviceScreenPresentationSupportQNX = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkBool32 GetPhysicalDeviceScreenPresentationSupportQNX(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, struct _screen_window* window) const noexcept;
#endif
    
#if defined(VK_EXT_debug_report)
    PFN_vkCreateDebugReportCallbackEXT vkCreateDebugReportCallbackEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateDebugReportCallbackEXT(VkInstance instance, const VkDebugReportCallbackCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugReportCallbackEXT* pCallback) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceImageFormatProperties2(VkPhysicalDevice physicalDevice, const VkPhysicalDeviceImageFormatInfo2* pImageFormatInfo, VkImageFormatProperties2* pImageFormatProperties) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceExternalMemorySciBufPropertiesNV(VkPhysicalDevice physicalDevice, VkExternalMemoryHandleTypeFlagBits handleType, NvSciBufObj handle, VkMemorySciBufPropertiesNV* pMemorySciBufProperties) const noexcept;
#endif
    
#if defined(VK_NV_external_memory_sci_buf)
    PFN_vkGetPhysicalDeviceSciBufAttributesNV vkGetPhysicalDeviceSciBufAttributesNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceSciBufAttributesNV(VkPhysicalDevice physicalDevice, NvSciBufAttrList pAttributes) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceSciSyncAttributesNV(VkPhysicalDevice physicalDevice, const VkSciSyncAttributesInfoNV* pSciSyncAttributesInfo, NvSciSyncAttrList pAttributes) const noexcept;
#endif
    
#if defined(VK_EXT_direct_mode_display)
    PFN_vkReleaseDisplayEXT vkReleaseDisplayEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ReleaseDisplayEXT(VkPhysicalDevice physicalDevice, VkDisplayKHR display) const noexcept;
#endif
    
#if defined(VK_EXT_acquire_xlib_display)
    PFN_vkAcquireXlibDisplayEXT vkAcquireXlibDisplayEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult AcquireXlibDisplayEXT(VkPhysicalDevice physicalDevice, Display* dpy, VkDisplayKHR display) const noexcept;
#endif
    
#if defined(VK_EXT_acquire_xlib_display)
    PFN_vkGetRandROutputDisplayEXT vkGetRandROutputDisplayEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetRandROutputDisplayEXT(VkPhysicalDevice physicalDevice, Display* dpy, RROutput rrOutput, VkDisplayKHR* pDisplay) const noexcept;
#endif
    
#if defined(VK_NV_acquire_winrt_display)
    PFN_vkAcquireWinrtDisplayNV vkAcquireWinrtDisplayNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult AcquireWinrtDisplayNV(VkPhysicalDevice physicalDevice, VkDisplayKHR display) const noexcept;
#endif
    
#if defined(VK_NV_acquire_winrt_display)
    PFN_vkGetWinrtDisplayNV vkGetWinrtDisplayNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetWinrtDisplayNV(VkPhysicalDevice physicalDevice, uint32_t deviceRelativeId, VkDisplayKHR* pDisplay) const noexcept;
#endif
    
#if defined(VK_EXT_display_surface_counter)
    PFN_vkGetPhysicalDeviceSurfaceCapabilities2EXT vkGetPhysicalDeviceSurfaceCapabilities2EXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceSurfaceCapabilities2EXT(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, VkSurfaceCapabilities2EXT* pSurfaceCapabilities) const noexcept;
#endif
    
#if defined(VKIT_API_VERSION_1_1)
    PFN_vkEnumeratePhysicalDeviceGroups vkEnumeratePhysicalDeviceGroups = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult EnumeratePhysicalDeviceGroups(VkInstance instance, uint32_t* pPhysicalDeviceGroupCount, VkPhysicalDeviceGroupProperties* pPhysicalDeviceGroupProperties) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDevicePresentRectanglesKHR(VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, uint32_t* pRectCount, VkRect2D* pRects) const noexcept;
#endif
    
#if defined(VK_MVK_ios_surface)
    PFN_vkCreateIOSSurfaceMVK vkCreateIOSSurfaceMVK = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateIOSSurfaceMVK(VkInstance instance, const VkIOSSurfaceCreateInfoMVK* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    
#if defined(VK_MVK_macos_surface)
    PFN_vkCreateMacOSSurfaceMVK vkCreateMacOSSurfaceMVK = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateMacOSSurfaceMVK(VkInstance instance, const VkMacOSSurfaceCreateInfoMVK* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    
#if defined(VK_EXT_metal_surface)
    PFN_vkCreateMetalSurfaceEXT vkCreateMetalSurfaceEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateMetalSurfaceEXT(VkInstance instance, const VkMetalSurfaceCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceSurfaceCapabilities2KHR(VkPhysicalDevice physicalDevice, const VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, VkSurfaceCapabilities2KHR* pSurfaceCapabilities) const noexcept;
#endif
    
#if defined(VK_KHR_get_surface_capabilities2)
    PFN_vkGetPhysicalDeviceSurfaceFormats2KHR vkGetPhysicalDeviceSurfaceFormats2KHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceSurfaceFormats2KHR(VkPhysicalDevice physicalDevice, const VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, uint32_t* pSurfaceFormatCount, VkSurfaceFormat2KHR* pSurfaceFormats) const noexcept;
#endif
    
#if defined(VK_KHR_get_display_properties2)
    PFN_vkGetPhysicalDeviceDisplayProperties2KHR vkGetPhysicalDeviceDisplayProperties2KHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceDisplayProperties2KHR(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayProperties2KHR* pProperties) const noexcept;
#endif
    
#if defined(VK_KHR_get_display_properties2)
    PFN_vkGetPhysicalDeviceDisplayPlaneProperties2KHR vkGetPhysicalDeviceDisplayPlaneProperties2KHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceDisplayPlaneProperties2KHR(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayPlaneProperties2KHR* pProperties) const noexcept;
#endif
    
#if defined(VK_KHR_get_display_properties2)
    PFN_vkGetDisplayModeProperties2KHR vkGetDisplayModeProperties2KHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetDisplayModeProperties2KHR(VkPhysicalDevice physicalDevice, VkDisplayKHR display, uint32_t* pPropertyCount, VkDisplayModeProperties2KHR* pProperties) const noexcept;
#endif
    
#if defined(VK_KHR_get_display_properties2)
    PFN_vkGetDisplayPlaneCapabilities2KHR vkGetDisplayPlaneCapabilities2KHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetDisplayPlaneCapabilities2KHR(VkPhysicalDevice physicalDevice, const VkDisplayPlaneInfo2KHR* pDisplayPlaneInfo, VkDisplayPlaneCapabilities2KHR* pCapabilities) const noexcept;
#endif
    
#if defined(VK_KHR_calibrated_timestamps)
    PFN_vkGetPhysicalDeviceCalibrateableTimeDomainsKHR vkGetPhysicalDeviceCalibrateableTimeDomainsKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceCalibrateableTimeDomainsKHR(VkPhysicalDevice physicalDevice, uint32_t* pTimeDomainCount, VkTimeDomainKHR* pTimeDomains) const noexcept;
#endif
    
#if defined(VK_EXT_debug_utils)
    PFN_vkCreateDebugUtilsMessengerEXT vkCreateDebugUtilsMessengerEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pMessenger) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceCooperativeMatrixPropertiesNV(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkCooperativeMatrixPropertiesNV* pProperties) const noexcept;
#endif
    
#if defined(VK_EXT_full_screen_exclusive)
    PFN_vkGetPhysicalDeviceSurfacePresentModes2EXT vkGetPhysicalDeviceSurfacePresentModes2EXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceSurfacePresentModes2EXT(VkPhysicalDevice physicalDevice, const VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, uint32_t* pPresentModeCount, VkPresentModeKHR* pPresentModes) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult EnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, uint32_t* pCounterCount, VkPerformanceCounterKHR* pCounters, VkPerformanceCounterDescriptionKHR* pCounterDescriptions) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateHeadlessSurfaceEXT(VkInstance instance, const VkHeadlessSurfaceCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(VkPhysicalDevice physicalDevice, uint32_t* pCombinationCount, VkFramebufferMixedSamplesCombinationNV* pCombinations) const noexcept;
#endif
    
#if defined(VKIT_API_VERSION_1_3)
    PFN_vkGetPhysicalDeviceToolProperties vkGetPhysicalDeviceToolProperties = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceToolProperties(VkPhysicalDevice physicalDevice, uint32_t* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceRefreshableObjectTypesKHR(VkPhysicalDevice physicalDevice, uint32_t* pRefreshableObjectTypeCount, VkObjectType* pRefreshableObjectTypes) const noexcept;
#endif
    
#if defined(VK_KHR_fragment_shading_rate)
    PFN_vkGetPhysicalDeviceFragmentShadingRatesKHR vkGetPhysicalDeviceFragmentShadingRatesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceFragmentShadingRatesKHR(VkPhysicalDevice physicalDevice, uint32_t* pFragmentShadingRateCount, VkPhysicalDeviceFragmentShadingRateKHR* pFragmentShadingRates) const noexcept;
#endif
    
#if defined(VK_KHR_video_queue)
    PFN_vkGetPhysicalDeviceVideoCapabilitiesKHR vkGetPhysicalDeviceVideoCapabilitiesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceVideoCapabilitiesKHR(VkPhysicalDevice physicalDevice, const VkVideoProfileInfoKHR* pVideoProfile, VkVideoCapabilitiesKHR* pCapabilities) const noexcept;
#endif
    
#if defined(VK_KHR_video_queue)
    PFN_vkGetPhysicalDeviceVideoFormatPropertiesKHR vkGetPhysicalDeviceVideoFormatPropertiesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceVideoFormatPropertiesKHR(VkPhysicalDevice physicalDevice, const VkPhysicalDeviceVideoFormatInfoKHR* pVideoFormatInfo, uint32_t* pVideoFormatPropertyCount, VkVideoFormatPropertiesKHR* pVideoFormatProperties) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR(VkPhysicalDevice physicalDevice, const VkPhysicalDeviceVideoEncodeQualityLevelInfoKHR* pQualityLevelInfo, VkVideoEncodeQualityLevelPropertiesKHR* pQualityLevelProperties) const noexcept;
#endif
    
#if defined(VK_EXT_acquire_drm_display)
    PFN_vkAcquireDrmDisplayEXT vkAcquireDrmDisplayEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult AcquireDrmDisplayEXT(VkPhysicalDevice physicalDevice, int32_t drmFd, VkDisplayKHR display) const noexcept;
#endif
    
#if defined(VK_EXT_acquire_drm_display)
    PFN_vkGetDrmDisplayEXT vkGetDrmDisplayEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetDrmDisplayEXT(VkPhysicalDevice physicalDevice, int32_t drmFd, uint32_t connectorId, VkDisplayKHR* display) const noexcept;
#endif
    
#if defined(VK_NV_optical_flow)
    PFN_vkGetPhysicalDeviceOpticalFlowImageFormatsNV vkGetPhysicalDeviceOpticalFlowImageFormatsNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceOpticalFlowImageFormatsNV(VkPhysicalDevice physicalDevice, const VkOpticalFlowImageFormatInfoNV* pOpticalFlowImageFormatInfo, uint32_t* pFormatCount, VkOpticalFlowImageFormatPropertiesNV* pImageFormatProperties) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceCooperativeMatrixPropertiesKHR(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkCooperativeMatrixPropertiesKHR* pProperties) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkCooperativeMatrixFlexibleDimensionsPropertiesNV* pProperties) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceCooperativeVectorPropertiesNV(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkCooperativeVectorPropertiesNV* pProperties) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceImageFormatProperties2KHR(VkPhysicalDevice physicalDevice, const VkPhysicalDeviceImageFormatInfo2KHR* pImageFormatInfo, VkImageFormatProperties2KHR* pImageFormatProperties) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult EnumeratePhysicalDeviceGroupsKHR(VkInstance instance, uint32_t* pPhysicalDeviceGroupCount, VkPhysicalDeviceGroupPropertiesKHR* pPhysicalDeviceGroupProperties) const noexcept;
#endif
    
#if defined(VK_EXT_calibrated_timestamps)
    PFN_vkGetPhysicalDeviceCalibrateableTimeDomainsEXT vkGetPhysicalDeviceCalibrateableTimeDomainsEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceCalibrateableTimeDomainsEXT(VkPhysicalDevice physicalDevice, uint32_t* pTimeDomainCount, VkTimeDomainEXT* pTimeDomains) const noexcept;
#endif
    
#if defined(VK_EXT_tooling_info)
    PFN_vkGetPhysicalDeviceToolPropertiesEXT vkGetPhysicalDeviceToolPropertiesEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPhysicalDeviceToolPropertiesEXT(VkPhysicalDevice physicalDevice, uint32_t* pToolCount, VkPhysicalDeviceToolPropertiesEXT* pToolProperties) const noexcept;
#endif
...
struct VKIT_API DeviceTable
{
    ...
    VKIT_LOADER_NO_DISCARD VkResult QueueSubmit(VkQueue queue, uint32_t submitCount, const VkSubmitInfo* pSubmits, VkFence fence) const noexcept;
    
    PFN_vkQueueWaitIdle vkQueueWaitIdle = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult QueueWaitIdle(VkQueue queue) const noexcept;
    
    PFN_vkDeviceWaitIdle vkDeviceWaitIdle = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult DeviceWaitIdle(VkDevice device) const noexcept;
    
    PFN_vkAllocateMemory vkAllocateMemory = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult AllocateMemory(VkDevice device, const VkMemoryAllocateInfo* pAllocateInfo, const VkAllocationCallbacks* pAllocator, VkDeviceMemory* pMemory) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult MapMemory(VkDevice device, VkDeviceMemory memory, VkDeviceSize offset, VkDeviceSize size, VkMemoryMapFlags flags, void** ppData) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult FlushMappedMemoryRanges(VkDevice device, uint32_t memoryRangeCount, const VkMappedMemoryRange* pMemoryRanges) const noexcept;
    
    PFN_vkInvalidateMappedMemoryRanges vkInvalidateMappedMemoryRanges = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult InvalidateMappedMemoryRanges(VkDevice device, uint32_t memoryRangeCount, const VkMappedMemoryRange* pMemoryRanges) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult BindBufferMemory(VkDevice device, VkBuffer buffer, VkDeviceMemory memory, VkDeviceSize memoryOffset) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult BindImageMemory(VkDevice device, VkImage image, VkDeviceMemory memory, VkDeviceSize memoryOffset) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult QueueBindSparse(VkQueue queue, uint32_t bindInfoCount, const VkBindSparseInfo* pBindInfo, VkFence fence) const noexcept;
    
    PFN_vkCreateFence vkCreateFence = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateFence(VkDevice device, const VkFenceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkFence* pFence) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult ResetFences(VkDevice device, uint32_t fenceCount, const VkFence* pFences) const noexcept;
    
    PFN_vkGetFenceStatus vkGetFenceStatus = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetFenceStatus(VkDevice device, VkFence fence) const noexcept;
    
    PFN_vkWaitForFences vkWaitForFences = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult WaitForFences(VkDevice device, uint32_t fenceCount, const VkFence* pFences, VkBool32 waitAll, uint64_t timeout) const noexcept;
    
    PFN_vkCreateSemaphore vkCreateSemaphore = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateSemaphore(VkDevice device, const VkSemaphoreCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSemaphore* pSemaphore) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateEvent(VkDevice device, const VkEventCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkEvent* pEvent) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetEventStatus(VkDevice device, VkEvent event) const noexcept;
    
    PFN_vkSetEvent vkSetEvent = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult SetEvent(VkDevice device, VkEvent event) const noexcept;
    
    PFN_vkResetEvent vkResetEvent = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ResetEvent(VkDevice device, VkEvent event) const noexcept;
    
    PFN_vkCreateQueryPool vkCreateQueryPool = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateQueryPool(VkDevice device, const VkQueryPoolCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkQueryPool* pQueryPool) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetQueryPoolResults(VkDevice device, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount, size_t dataSize, void* pData, VkDeviceSize stride, VkQueryResultFlags flags) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateBuffer(VkDevice device, const VkBufferCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkBuffer* pBuffer) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateBufferView(VkDevice device, const VkBufferViewCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkBufferView* pView) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateImage(VkDevice device, const VkImageCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkImage* pImage) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateImageView(VkDevice device, const VkImageViewCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkImageView* pView) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateShaderModule(VkDevice device, const VkShaderModuleCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkShaderModule* pShaderModule) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreatePipelineCache(VkDevice device, const VkPipelineCacheCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPipelineCache* pPipelineCache) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPipelineCacheData(VkDevice device, VkPipelineCache pipelineCache, size_t* pDataSize, void* pData) const noexcept;
    
    PFN_vkMergePipelineCaches vkMergePipelineCaches = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult MergePipelineCaches(VkDevice device, VkPipelineCache dstCache, uint32_t srcCacheCount, const VkPipelineCache* pSrcCaches) const noexcept;
    
#if defined(VK_KHR_pipeline_binary)
    PFN_vkCreatePipelineBinariesKHR vkCreatePipelineBinariesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreatePipelineBinariesKHR(VkDevice device, const VkPipelineBinaryCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPipelineBinaryHandlesInfoKHR* pBinaries) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPipelineKeyKHR(VkDevice device, const VkPipelineCreateInfoKHR* pPipelineCreateInfo, VkPipelineBinaryKeyKHR* pPipelineKey) const noexcept;
#endif
    
#if defined(VK_KHR_pipeline_binary)
    PFN_vkGetPipelineBinaryDataKHR vkGetPipelineBinaryDataKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPipelineBinaryDataKHR(VkDevice device, const VkPipelineBinaryDataInfoKHR* pInfo, VkPipelineBinaryKeyKHR* pPipelineBinaryKey, size_t* pPipelineBinaryDataSize, void* pPipelineBinaryData) const noexcept;
#endif
    
#if defined(VK_KHR_pipeline_binary)
    PFN_vkReleaseCapturedPipelineDataKHR vkReleaseCapturedPipelineDataKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ReleaseCapturedPipelineDataKHR(VkDevice device, const VkReleaseCapturedPipelineDataInfoKHR* pInfo, const VkAllocationCallbacks* pAllocator) const noexcept;
#endif
    
    PFN_vkCreateGraphicsPipelines vkCreateGraphicsPipelines = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateGraphicsPipelines(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkGraphicsPipelineCreateInfo* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines) const noexcept;
    
    PFN_vkCreateComputePipelines vkCreateComputePipelines = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateComputePipelines(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkComputePipelineCreateInfo* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI(VkDevice device, VkRenderPass renderpass, VkExtent2D* pMaxWorkgroupSize) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreatePipelineLayout(VkDevice device, const VkPipelineLayoutCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPipelineLayout* pPipelineLayout) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateSampler(VkDevice device, const VkSamplerCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSampler* pSampler) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateDescriptorSetLayout(VkDevice device, const VkDescriptorSetLayoutCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDescriptorSetLayout* pSetLayout) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateDescriptorPool(VkDevice device, const VkDescriptorPoolCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDescriptorPool* pDescriptorPool) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult ResetDescriptorPool(VkDevice device, VkDescriptorPool descriptorPool, VkDescriptorPoolResetFlags flags) const noexcept;
    
    PFN_vkAllocateDescriptorSets vkAllocateDescriptorSets = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult AllocateDescriptorSets(VkDevice device, const VkDescriptorSetAllocateInfo* pAllocateInfo, VkDescriptorSet* pDescriptorSets) const noexcept;
    
    PFN_vkFreeDescriptorSets vkFreeDescriptorSets = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult FreeDescriptorSets(VkDevice device, VkDescriptorPool descriptorPool, uint32_t descriptorSetCount, const VkDescriptorSet* pDescriptorSets) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateFramebuffer(VkDevice device, const VkFramebufferCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkFramebuffer* pFramebuffer) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateRenderPass(VkDevice device, const VkRenderPassCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateCommandPool(VkDevice device, const VkCommandPoolCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkCommandPool* pCommandPool) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult ResetCommandPool(VkDevice device, VkCommandPool commandPool, VkCommandPoolResetFlags flags) const noexcept;
    
    PFN_vkAllocateCommandBuffers vkAllocateCommandBuffers = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult AllocateCommandBuffers(VkDevice device, const VkCommandBufferAllocateInfo* pAllocateInfo, VkCommandBuffer* pCommandBuffers) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult BeginCommandBuffer(VkCommandBuffer commandBuffer, const VkCommandBufferBeginInfo* pBeginInfo) const noexcept;
    
    PFN_vkEndCommandBuffer vkEndCommandBuffer = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult EndCommandBuffer(VkCommandBuffer commandBuffer) const noexcept;
    
    PFN_vkResetCommandBuffer vkResetCommandBuffer = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ResetCommandBuffer(VkCommandBuffer commandBuffer, VkCommandBufferResetFlags flags) const noexcept;
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateSharedSwapchainsKHR(VkDevice device, uint32_t swapchainCount, const VkSwapchainCreateInfoKHR* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkSwapchainKHR* pSwapchains) const noexcept;
#endif
    
#if defined(VK_KHR_swapchain)
    PFN_vkCreateSwapchainKHR vkCreateSwapchainKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateSwapchainKHR(VkDevice device, const VkSwapchainCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSwapchainKHR* pSwapchain) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetSwapchainImagesKHR(VkDevice device, VkSwapchainKHR swapchain, uint32_t* pSwapchainImageCount, VkImage* pSwapchainImages) const noexcept;
#endif
    
#if defined(VK_KHR_swapchain)
    PFN_vkAcquireNextImageKHR vkAcquireNextImageKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult AcquireNextImageKHR(VkDevice device, VkSwapchainKHR swapchain, uint64_t timeout, VkSemaphore semaphore, VkFence fence, uint32_t* pImageIndex) const noexcept;
#endif
    
#if defined(VK_KHR_swapchain)
    PFN_vkQueuePresentKHR vkQueuePresentKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult QueuePresentKHR(VkQueue queue, const VkPresentInfoKHR* pPresentInfo) const noexcept;
#endif
    
#if defined(VK_EXT_debug_marker)
    PFN_vkDebugMarkerSetObjectNameEXT vkDebugMarkerSetObjectNameEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult DebugMarkerSetObjectNameEXT(VkDevice device, const VkDebugMarkerObjectNameInfoEXT* pNameInfo) const noexcept;
#endif
    
#if defined(VK_EXT_debug_marker)
    PFN_vkDebugMarkerSetObjectTagEXT vkDebugMarkerSetObjectTagEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult DebugMarkerSetObjectTagEXT(VkDevice device, const VkDebugMarkerObjectTagInfoEXT* pTagInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetMemoryWin32HandleNV(VkDevice device, VkDeviceMemory memory, VkExternalMemoryHandleTypeFlagsNV handleType, HANDLE* pHandle) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateIndirectCommandsLayoutNV(VkDevice device, const VkIndirectCommandsLayoutCreateInfoNV* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkIndirectCommandsLayoutNV* pIndirectCommandsLayout) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateIndirectCommandsLayoutEXT(VkDevice device, const VkIndirectCommandsLayoutCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkIndirectCommandsLayoutEXT* pIndirectCommandsLayout) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateIndirectExecutionSetEXT(VkDevice device, const VkIndirectExecutionSetCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkIndirectExecutionSetEXT* pIndirectExecutionSet) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetMemoryWin32HandleKHR(VkDevice device, const VkMemoryGetWin32HandleInfoKHR* pGetWin32HandleInfo, HANDLE* pHandle) const noexcept;
#endif
    
#if defined(VK_KHR_external_memory_win32)
    PFN_vkGetMemoryWin32HandlePropertiesKHR vkGetMemoryWin32HandlePropertiesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetMemoryWin32HandlePropertiesKHR(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, HANDLE handle, VkMemoryWin32HandlePropertiesKHR* pMemoryWin32HandleProperties) const noexcept;
#endif
    
#if defined(VK_KHR_external_memory_fd)
    PFN_vkGetMemoryFdKHR vkGetMemoryFdKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetMemoryFdKHR(VkDevice device, const VkMemoryGetFdInfoKHR* pGetFdInfo, int* pFd) const noexcept;
#endif
    
#if defined(VK_KHR_external_memory_fd)
    PFN_vkGetMemoryFdPropertiesKHR vkGetMemoryFdPropertiesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetMemoryFdPropertiesKHR(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, int fd, VkMemoryFdPropertiesKHR* pMemoryFdProperties) const noexcept;
#endif
    
#if defined(VK_FUCHSIA_external_memory)
    PFN_vkGetMemoryZirconHandleFUCHSIA vkGetMemoryZirconHandleFUCHSIA = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetMemoryZirconHandleFUCHSIA(VkDevice device, const VkMemoryGetZirconHandleInfoFUCHSIA* pGetZirconHandleInfo, zx_handle_t* pZirconHandle) const noexcept;
#endif
    
#if defined(VK_FUCHSIA_external_memory)
    PFN_vkGetMemoryZirconHandlePropertiesFUCHSIA vkGetMemoryZirconHandlePropertiesFUCHSIA = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetMemoryZirconHandlePropertiesFUCHSIA(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, zx_handle_t zirconHandle, VkMemoryZirconHandlePropertiesFUCHSIA* pMemoryZirconHandleProperties) const noexcept;
#endif
    
#if defined(VK_NV_external_memory_rdma)
    PFN_vkGetMemoryRemoteAddressNV vkGetMemoryRemoteAddressNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetMemoryRemoteAddressNV(VkDevice device, const VkMemoryGetRemoteAddressInfoNV* pMemoryGetRemoteAddressInfo, VkRemoteAddressNV* pAddress) const noexcept;
#endif
    
#if defined(VK_NV_external_memory_sci_buf)
    PFN_vkGetMemorySciBufNV vkGetMemorySciBufNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetMemorySciBufNV(VkDevice device, const VkMemoryGetSciBufInfoNV* pGetSciBufInfo, NvSciBufObj* pHandle) const noexcept;
#endif
    
#if defined(VK_KHR_external_semaphore_win32)
    PFN_vkGetSemaphoreWin32HandleKHR vkGetSemaphoreWin32HandleKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetSemaphoreWin32HandleKHR(VkDevice device, const VkSemaphoreGetWin32HandleInfoKHR* pGetWin32HandleInfo, HANDLE* pHandle) const noexcept;
#endif
    
#if defined(VK_KHR_external_semaphore_win32)
    PFN_vkImportSemaphoreWin32HandleKHR vkImportSemaphoreWin32HandleKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ImportSemaphoreWin32HandleKHR(VkDevice device, const VkImportSemaphoreWin32HandleInfoKHR* pImportSemaphoreWin32HandleInfo) const noexcept;
#endif
    
#if defined(VK_KHR_external_semaphore_fd)
    PFN_vkGetSemaphoreFdKHR vkGetSemaphoreFdKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetSemaphoreFdKHR(VkDevice device, const VkSemaphoreGetFdInfoKHR* pGetFdInfo, int* pFd) const noexcept;
#endif
    
#if defined(VK_KHR_external_semaphore_fd)
    PFN_vkImportSemaphoreFdKHR vkImportSemaphoreFdKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ImportSemaphoreFdKHR(VkDevice device, const VkImportSemaphoreFdInfoKHR* pImportSemaphoreFdInfo) const noexcept;
#endif
    
#if defined(VK_FUCHSIA_external_semaphore)
    PFN_vkGetSemaphoreZirconHandleFUCHSIA vkGetSemaphoreZirconHandleFUCHSIA = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetSemaphoreZirconHandleFUCHSIA(VkDevice device, const VkSemaphoreGetZirconHandleInfoFUCHSIA* pGetZirconHandleInfo, zx_handle_t* pZirconHandle) const noexcept;
#endif
    
#if defined(VK_FUCHSIA_external_semaphore)
    PFN_vkImportSemaphoreZirconHandleFUCHSIA vkImportSemaphoreZirconHandleFUCHSIA = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ImportSemaphoreZirconHandleFUCHSIA(VkDevice device, const VkImportSemaphoreZirconHandleInfoFUCHSIA* pImportSemaphoreZirconHandleInfo) const noexcept;
#endif
    
#if defined(VK_KHR_external_fence_win32)
    PFN_vkGetFenceWin32HandleKHR vkGetFenceWin32HandleKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetFenceWin32HandleKHR(VkDevice device, const VkFenceGetWin32HandleInfoKHR* pGetWin32HandleInfo, HANDLE* pHandle) const noexcept;
#endif
    
#if defined(VK_KHR_external_fence_win32)
    PFN_vkImportFenceWin32HandleKHR vkImportFenceWin32HandleKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ImportFenceWin32HandleKHR(VkDevice device, const VkImportFenceWin32HandleInfoKHR* pImportFenceWin32HandleInfo) const noexcept;
#endif
    
#if defined(VK_KHR_external_fence_fd)
    PFN_vkGetFenceFdKHR vkGetFenceFdKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetFenceFdKHR(VkDevice device, const VkFenceGetFdInfoKHR* pGetFdInfo, int* pFd) const noexcept;
#endif
    
#if defined(VK_KHR_external_fence_fd)
    PFN_vkImportFenceFdKHR vkImportFenceFdKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ImportFenceFdKHR(VkDevice device, const VkImportFenceFdInfoKHR* pImportFenceFdInfo) const noexcept;
#endif
    
#if defined(VK_NV_external_sci_sync) || defined(VK_NV_external_sci_sync2)
    PFN_vkGetFenceSciSyncFenceNV vkGetFenceSciSyncFenceNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetFenceSciSyncFenceNV(VkDevice device, const VkFenceGetSciSyncInfoNV* pGetSciSyncHandleInfo, void* pHandle) const noexcept;
#endif
    
#if defined(VK_NV_external_sci_sync) || defined(VK_NV_external_sci_sync2)
    PFN_vkGetFenceSciSyncObjNV vkGetFenceSciSyncObjNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetFenceSciSyncObjNV(VkDevice device, const VkFenceGetSciSyncInfoNV* pGetSciSyncHandleInfo, void* pHandle) const noexcept;
#endif
    
#if defined(VK_NV_external_sci_sync) || defined(VK_NV_external_sci_sync2)
    PFN_vkImportFenceSciSyncFenceNV vkImportFenceSciSyncFenceNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ImportFenceSciSyncFenceNV(VkDevice device, const VkImportFenceSciSyncInfoNV* pImportFenceSciSyncInfo) const noexcept;
#endif
    
#if defined(VK_NV_external_sci_sync) || defined(VK_NV_external_sci_sync2)
    PFN_vkImportFenceSciSyncObjNV vkImportFenceSciSyncObjNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ImportFenceSciSyncObjNV(VkDevice device, const VkImportFenceSciSyncInfoNV* pImportFenceSciSyncInfo) const noexcept;
#endif
    
#if defined(VK_NV_external_sci_sync)
    PFN_vkGetSemaphoreSciSyncObjNV vkGetSemaphoreSciSyncObjNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetSemaphoreSciSyncObjNV(VkDevice device, const VkSemaphoreGetSciSyncInfoNV* pGetSciSyncInfo, void* pHandle) const noexcept;
#endif
    
#if defined(VK_NV_external_sci_sync)
    PFN_vkImportSemaphoreSciSyncObjNV vkImportSemaphoreSciSyncObjNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ImportSemaphoreSciSyncObjNV(VkDevice device, const VkImportSemaphoreSciSyncInfoNV* pImportSemaphoreSciSyncInfo) const noexcept;
#endif
    
#if defined(VK_NV_external_sci_sync2)
    PFN_vkCreateSemaphoreSciSyncPoolNV vkCreateSemaphoreSciSyncPoolNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateSemaphoreSciSyncPoolNV(VkDevice device, const VkSemaphoreSciSyncPoolCreateInfoNV* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSemaphoreSciSyncPoolNV* pSemaphorePool) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult DisplayPowerControlEXT(VkDevice device, VkDisplayKHR display, const VkDisplayPowerInfoEXT* pDisplayPowerInfo) const noexcept;
#endif
    
#if defined(VK_EXT_display_control)
    PFN_vkRegisterDeviceEventEXT vkRegisterDeviceEventEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult RegisterDeviceEventEXT(VkDevice device, const VkDeviceEventInfoEXT* pDeviceEventInfo, const VkAllocationCallbacks* pAllocator, VkFence* pFence) const noexcept;
#endif
    
#if defined(VK_EXT_display_control)
    PFN_vkRegisterDisplayEventEXT vkRegisterDisplayEventEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult RegisterDisplayEventEXT(VkDevice device, VkDisplayKHR display, const VkDisplayEventInfoEXT* pDisplayEventInfo, const VkAllocationCallbacks* pAllocator, VkFence* pFence) const noexcept;
#endif
    
#if defined(VK_EXT_display_control)
    PFN_vkGetSwapchainCounterEXT vkGetSwapchainCounterEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetSwapchainCounterEXT(VkDevice device, VkSwapchainKHR swapchain, VkSurfaceCounterFlagBitsEXT counter, uint64_t* pCounterValue) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult BindBufferMemory2(VkDevice device, uint32_t bindInfoCount, const VkBindBufferMemoryInfo* pBindInfos) const noexcept;
#endif
    
#if defined(VKIT_API_VERSION_1_1)
    PFN_vkBindImageMemory2 vkBindImageMemory2 = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult BindImageMemory2(VkDevice device, uint32_t bindInfoCount, const VkBindImageMemoryInfo* pBindInfos) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetDeviceGroupPresentCapabilitiesKHR(VkDevice device, VkDeviceGroupPresentCapabilitiesKHR* pDeviceGroupPresentCapabilities) const noexcept;
#endif
    
#if (defined(VK_KHR_swapchain) && defined(VKIT_API_VERSION_1_1)) || (defined(VK_KHR_device_group) && defined(VK_KHR_surface))
    PFN_vkGetDeviceGroupSurfacePresentModesKHR vkGetDeviceGroupSurfacePresentModesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetDeviceGroupSurfacePresentModesKHR(VkDevice device, VkSurfaceKHR surface, VkDeviceGroupPresentModeFlagsKHR* pModes) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult AcquireNextImage2KHR(VkDevice device, const VkAcquireNextImageInfoKHR* pAcquireInfo, uint32_t* pImageIndex) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateDescriptorUpdateTemplate(VkDevice device, const VkDescriptorUpdateTemplateCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDescriptorUpdateTemplate* pDescriptorUpdateTemplate) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetSwapchainStatusKHR(VkDevice device, VkSwapchainKHR swapchain) const noexcept;
#endif
    
#if defined(VK_GOOGLE_display_timing)
    PFN_vkGetRefreshCycleDurationGOOGLE vkGetRefreshCycleDurationGOOGLE = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetRefreshCycleDurationGOOGLE(VkDevice device, VkSwapchainKHR swapchain, VkRefreshCycleDurationGOOGLE* pDisplayTimingProperties) const noexcept;
#endif
    
#if defined(VK_GOOGLE_display_timing)
    PFN_vkGetPastPresentationTimingGOOGLE vkGetPastPresentationTimingGOOGLE = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPastPresentationTimingGOOGLE(VkDevice device, VkSwapchainKHR swapchain, uint32_t* pPresentationTimingCount, VkPastPresentationTimingGOOGLE* pPresentationTimings) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateSamplerYcbcrConversion(VkDevice device, const VkSamplerYcbcrConversionCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSamplerYcbcrConversion* pYcbcrConversion) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateValidationCacheEXT(VkDevice device, const VkValidationCacheCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkValidationCacheEXT* pValidationCache) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetValidationCacheDataEXT(VkDevice device, VkValidationCacheEXT validationCache, size_t* pDataSize, void* pData) const noexcept;
#endif
    
#if defined(VK_EXT_validation_cache)
    PFN_vkMergeValidationCachesEXT vkMergeValidationCachesEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult MergeValidationCachesEXT(VkDevice device, VkValidationCacheEXT dstCache, uint32_t srcCacheCount, const VkValidationCacheEXT* pSrcCaches) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetSwapchainGrallocUsageANDROID(VkDevice device, VkFormat format, VkImageUsageFlags imageUsage, int* grallocUsage) const noexcept;
#endif
    
#if defined(VK_ANDROID_native_buffer)
    PFN_vkGetSwapchainGrallocUsage2ANDROID vkGetSwapchainGrallocUsage2ANDROID = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetSwapchainGrallocUsage2ANDROID(VkDevice device, VkFormat format, VkImageUsageFlags imageUsage, VkSwapchainImageUsageFlagsANDROID swapchainImageUsage, uint64_t* grallocConsumerUsage, uint64_t* grallocProducerUsage) const noexcept;
#endif
    
#if defined(VK_ANDROID_native_buffer)
    PFN_vkAcquireImageANDROID vkAcquireImageANDROID = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult AcquireImageANDROID(VkDevice device, VkImage image, int nativeFenceFd, VkSemaphore semaphore, VkFence fence) const noexcept;
#endif
    
#if defined(VK_ANDROID_native_buffer)
    PFN_vkQueueSignalReleaseImageANDROID vkQueueSignalReleaseImageANDROID = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult QueueSignalReleaseImageANDROID(VkQueue queue, uint32_t waitSemaphoreCount, const VkSemaphore* pWaitSemaphores, VkImage image, int* pNativeFenceFd) const noexcept;
#endif
    
#if defined(VK_AMD_shader_info)
    PFN_vkGetShaderInfoAMD vkGetShaderInfoAMD = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetShaderInfoAMD(VkDevice device, VkPipeline pipeline, VkShaderStageFlagBits shaderStage, VkShaderInfoTypeAMD infoType, size_t* pInfoSize, void* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetCalibratedTimestampsKHR(VkDevice device, uint32_t timestampCount, const VkCalibratedTimestampInfoKHR* pTimestampInfos, uint64_t* pTimestamps, uint64_t* pMaxDeviation) const noexcept;
#endif
    
#if defined(VK_EXT_debug_utils)
    PFN_vkSetDebugUtilsObjectNameEXT vkSetDebugUtilsObjectNameEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult SetDebugUtilsObjectNameEXT(VkDevice device, const VkDebugUtilsObjectNameInfoEXT* pNameInfo) const noexcept;
#endif
    
#if defined(VK_EXT_debug_utils)
    PFN_vkSetDebugUtilsObjectTagEXT vkSetDebugUtilsObjectTagEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult SetDebugUtilsObjectTagEXT(VkDevice device, const VkDebugUtilsObjectTagInfoEXT* pTagInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetMemoryHostPointerPropertiesEXT(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, const void* pHostPointer, VkMemoryHostPointerPropertiesEXT* pMemoryHostPointerProperties) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateRenderPass2(VkDevice device, const VkRenderPassCreateInfo2* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetSemaphoreCounterValue(VkDevice device, VkSemaphore semaphore, uint64_t* pValue) const noexcept;
#endif
    
#if defined(VKIT_API_VERSION_1_2)
    PFN_vkWaitSemaphores vkWaitSemaphores = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult WaitSemaphores(VkDevice device, const VkSemaphoreWaitInfo* pWaitInfo, uint64_t timeout) const noexcept;
#endif
    
#if defined(VKIT_API_VERSION_1_2)
    PFN_vkSignalSemaphore vkSignalSemaphore = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult SignalSemaphore(VkDevice device, const VkSemaphoreSignalInfo* pSignalInfo) const noexcept;
#endif
    
#if defined(VK_ANDROID_external_memory_android_hardware_buffer)
    PFN_vkGetAndroidHardwareBufferPropertiesANDROID vkGetAndroidHardwareBufferPropertiesANDROID = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetAndroidHardwareBufferPropertiesANDROID(VkDevice device, const struct AHardwareBuffer* buffer, VkAndroidHardwareBufferPropertiesANDROID* pProperties) const noexcept;
#endif
    
#if defined(VK_ANDROID_external_memory_android_hardware_buffer)
    PFN_vkGetMemoryAndroidHardwareBufferANDROID vkGetMemoryAndroidHardwareBufferANDROID = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetMemoryAndroidHardwareBufferANDROID(VkDevice device, const VkMemoryGetAndroidHardwareBufferInfoANDROID* pInfo, struct AHardwareBuffer** pBuffer) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CompileDeferredNV(VkDevice device, VkPipeline pipeline, uint32_t shader) const noexcept;
#endif
    
#if defined(VK_NV_ray_tracing)
    PFN_vkCreateAccelerationStructureNV vkCreateAccelerationStructureNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateAccelerationStructureNV(VkDevice device, const VkAccelerationStructureCreateInfoNV* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkAccelerationStructureNV* pAccelerationStructure) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult BindAccelerationStructureMemoryNV(VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoNV* pBindInfos) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CopyAccelerationStructureKHR(VkDevice device, VkDeferredOperationKHR deferredOperation, const VkCopyAccelerationStructureInfoKHR* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CopyAccelerationStructureToMemoryKHR(VkDevice device, VkDeferredOperationKHR deferredOperation, const VkCopyAccelerationStructureToMemoryInfoKHR* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CopyMemoryToAccelerationStructureKHR(VkDevice device, VkDeferredOperationKHR deferredOperation, const VkCopyMemoryToAccelerationStructureInfoKHR* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult WriteAccelerationStructuresPropertiesKHR(VkDevice device, uint32_t accelerationStructureCount, const VkAccelerationStructureKHR* pAccelerationStructures, VkQueryType queryType, size_t dataSize, void* pData, size_t stride) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetRayTracingShaderGroupHandlesKHR(VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData) const noexcept;
#endif
    
#if defined(VK_KHR_ray_tracing_pipeline)
    PFN_vkGetRayTracingCaptureReplayShaderGroupHandlesKHR vkGetRayTracingCaptureReplayShaderGroupHandlesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetRayTracingCaptureReplayShaderGroupHandlesKHR(VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData) const noexcept;
#endif
    
#if defined(VK_NV_ray_tracing)
    PFN_vkGetAccelerationStructureHandleNV vkGetAccelerationStructureHandleNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetAccelerationStructureHandleNV(VkDevice device, VkAccelerationStructureNV accelerationStructure, size_t dataSize, void* pData) const noexcept;
#endif
    
#if defined(VK_NV_ray_tracing)
    PFN_vkCreateRayTracingPipelinesNV vkCreateRayTracingPipelinesNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateRayTracingPipelinesNV(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkRayTracingPipelineCreateInfoNV* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkDeviceSize GetRayTracingShaderGroupStackSizeKHR(VkDevice device, VkPipeline pipeline, uint32_t group, VkShaderGroupShaderKHR groupShader) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD uint32_t GetImageViewHandleNVX(VkDevice device, const VkImageViewHandleInfoNVX* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD uint64_t GetImageViewHandle64NVX(VkDevice device, const VkImageViewHandleInfoNVX* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetImageViewAddressNVX(VkDevice device, VkImageView imageView, VkImageViewAddressPropertiesNVX* pProperties) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetDeviceGroupSurfacePresentModes2EXT(VkDevice device, const VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, VkDeviceGroupPresentModeFlagsKHR* pModes) const noexcept;
#endif
    
#if defined(VK_EXT_full_screen_exclusive)
    PFN_vkAcquireFullScreenExclusiveModeEXT vkAcquireFullScreenExclusiveModeEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult AcquireFullScreenExclusiveModeEXT(VkDevice device, VkSwapchainKHR swapchain) const noexcept;
#endif
    
#if defined(VK_EXT_full_screen_exclusive)
    PFN_vkReleaseFullScreenExclusiveModeEXT vkReleaseFullScreenExclusiveModeEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ReleaseFullScreenExclusiveModeEXT(VkDevice device, VkSwapchainKHR swapchain) const noexcept;
#endif
    
#if defined(VK_KHR_performance_query)
    PFN_vkAcquireProfilingLockKHR vkAcquireProfilingLockKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult AcquireProfilingLockKHR(VkDevice device, const VkAcquireProfilingLockInfoKHR* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetImageDrmFormatModifierPropertiesEXT(VkDevice device, VkImage image, VkImageDrmFormatModifierPropertiesEXT* pProperties) const noexcept;
#endif
    
#if defined(VKIT_API_VERSION_1_2)
    PFN_vkGetBufferOpaqueCaptureAddress vkGetBufferOpaqueCaptureAddress = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD uint64_t GetBufferOpaqueCaptureAddress(VkDevice device, const VkBufferDeviceAddressInfo* pInfo) const noexcept;
#endif
    
#if defined(VKIT_API_VERSION_1_2)
    PFN_vkGetBufferDeviceAddress vkGetBufferDeviceAddress = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkDeviceAddress GetBufferDeviceAddress(VkDevice device, const VkBufferDeviceAddressInfo* pInfo) const noexcept;
#endif
    
#if defined(VK_INTEL_performance_query)
    PFN_vkInitializePerformanceApiINTEL vkInitializePerformanceApiINTEL = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult InitializePerformanceApiINTEL(VkDevice device, const VkInitializePerformanceApiInfoINTEL* pInitializeInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CmdSetPerformanceMarkerINTEL(VkCommandBuffer commandBuffer, const VkPerformanceMarkerInfoINTEL* pMarkerInfo) const noexcept;
#endif
    
#if defined(VK_INTEL_performance_query)
    PFN_vkCmdSetPerformanceStreamMarkerINTEL vkCmdSetPerformanceStreamMarkerINTEL = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CmdSetPerformanceStreamMarkerINTEL(VkCommandBuffer commandBuffer, const VkPerformanceStreamMarkerInfoINTEL* pMarkerInfo) const noexcept;
#endif
    
#if defined(VK_INTEL_performance_query)
    PFN_vkCmdSetPerformanceOverrideINTEL vkCmdSetPerformanceOverrideINTEL = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CmdSetPerformanceOverrideINTEL(VkCommandBuffer commandBuffer, const VkPerformanceOverrideInfoINTEL* pOverrideInfo) const noexcept;
#endif
    
#if defined(VK_INTEL_performance_query)
    PFN_vkAcquirePerformanceConfigurationINTEL vkAcquirePerformanceConfigurationINTEL = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult AcquirePerformanceConfigurationINTEL(VkDevice device, const VkPerformanceConfigurationAcquireInfoINTEL* pAcquireInfo, VkPerformanceConfigurationINTEL* pConfiguration) const noexcept;
#endif
    
#if defined(VK_INTEL_performance_query)
    PFN_vkReleasePerformanceConfigurationINTEL vkReleasePerformanceConfigurationINTEL = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ReleasePerformanceConfigurationINTEL(VkDevice device, VkPerformanceConfigurationINTEL configuration) const noexcept;
#endif
    
#if defined(VK_INTEL_performance_query)
    PFN_vkQueueSetPerformanceConfigurationINTEL vkQueueSetPerformanceConfigurationINTEL = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult QueueSetPerformanceConfigurationINTEL(VkQueue queue, VkPerformanceConfigurationINTEL configuration) const noexcept;
#endif
    
#if defined(VK_INTEL_performance_query)
    PFN_vkGetPerformanceParameterINTEL vkGetPerformanceParameterINTEL = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPerformanceParameterINTEL(VkDevice device, VkPerformanceParameterTypeINTEL parameter, VkPerformanceValueINTEL* pValue) const noexcept;
#endif
    
#if defined(VKIT_API_VERSION_1_2)
    PFN_vkGetDeviceMemoryOpaqueCaptureAddress vkGetDeviceMemoryOpaqueCaptureAddress = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD uint64_t GetDeviceMemoryOpaqueCaptureAddress(VkDevice device, const VkDeviceMemoryOpaqueCaptureAddressInfo* pInfo) const noexcept;
#endif
    
#if defined(VK_KHR_pipeline_executable_properties)
    PFN_vkGetPipelineExecutablePropertiesKHR vkGetPipelineExecutablePropertiesKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPipelineExecutablePropertiesKHR(VkDevice device, const VkPipelineInfoKHR* pPipelineInfo, uint32_t* pExecutableCount, VkPipelineExecutablePropertiesKHR* pProperties) const noexcept;
#endif
    
#if defined(VK_KHR_pipeline_executable_properties)
    PFN_vkGetPipelineExecutableStatisticsKHR vkGetPipelineExecutableStatisticsKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPipelineExecutableStatisticsKHR(VkDevice device, const VkPipelineExecutableInfoKHR* pExecutableInfo, uint32_t* pStatisticCount, VkPipelineExecutableStatisticKHR* pStatistics) const noexcept;
#endif
    
#if defined(VK_KHR_pipeline_executable_properties)
    PFN_vkGetPipelineExecutableInternalRepresentationsKHR vkGetPipelineExecutableInternalRepresentationsKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetPipelineExecutableInternalRepresentationsKHR(VkDevice device, const VkPipelineExecutableInfoKHR* pExecutableInfo, uint32_t* pInternalRepresentationCount, VkPipelineExecutableInternalRepresentationKHR* pInternalRepresentations) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetFaultData(VkDevice device, VkFaultQueryBehavior faultQueryBehavior, VkBool32* pUnrecordedFaults, uint32_t* pFaultCount, VkFaultData* pFaults) const noexcept;
#endif
    
#if defined(VK_KHR_acceleration_structure)
    PFN_vkCreateAccelerationStructureKHR vkCreateAccelerationStructureKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateAccelerationStructureKHR(VkDevice device, const VkAccelerationStructureCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkAccelerationStructureKHR* pAccelerationStructure) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult BuildAccelerationStructuresKHR(VkDevice device, VkDeferredOperationKHR deferredOperation, uint32_t infoCount, const VkAccelerationStructureBuildGeometryInfoKHR* pInfos, const VkAccelerationStructureBuildRangeInfoKHR* const* ppBuildRangeInfos) const noexcept;
#endif
    
#if defined(VK_KHR_acceleration_structure)
    PFN_vkGetAccelerationStructureDeviceAddressKHR vkGetAccelerationStructureDeviceAddressKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkDeviceAddress GetAccelerationStructureDeviceAddressKHR(VkDevice device, const VkAccelerationStructureDeviceAddressInfoKHR* pInfo) const noexcept;
#endif
    
#if defined(VK_KHR_deferred_host_operations)
    PFN_vkCreateDeferredOperationKHR vkCreateDeferredOperationKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateDeferredOperationKHR(VkDevice device, const VkAllocationCallbacks* pAllocator, VkDeferredOperationKHR* pDeferredOperation) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD uint32_t GetDeferredOperationMaxConcurrencyKHR(VkDevice device, VkDeferredOperationKHR operation) const noexcept;
#endif
    
#if defined(VK_KHR_deferred_host_operations)
    PFN_vkGetDeferredOperationResultKHR vkGetDeferredOperationResultKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetDeferredOperationResultKHR(VkDevice device, VkDeferredOperationKHR operation) const noexcept;
#endif
    
#if defined(VK_KHR_deferred_host_operations)
    PFN_vkDeferredOperationJoinKHR vkDeferredOperationJoinKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult DeferredOperationJoinKHR(VkDevice device, VkDeferredOperationKHR operation) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkDeviceAddress GetPipelineIndirectDeviceAddressNV(VkDevice device, const VkPipelineIndirectDeviceAddressInfoNV* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreatePrivateDataSlot(VkDevice device, const VkPrivateDataSlotCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPrivateDataSlot* pPrivateDataSlot) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult SetPrivateData(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t data) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult QueueSubmit2(VkQueue queue, uint32_t submitCount, const VkSubmitInfo2* pSubmits, VkFence fence) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CopyMemoryToImage(VkDevice device, const VkCopyMemoryToImageInfo* pCopyMemoryToImageInfo) const noexcept;
#endif
    
#if defined(VKIT_API_VERSION_1_4)
    PFN_vkCopyImageToMemory vkCopyImageToMemory = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CopyImageToMemory(VkDevice device, const VkCopyImageToMemoryInfo* pCopyImageToMemoryInfo) const noexcept;
#endif
    
#if defined(VKIT_API_VERSION_1_4)
    PFN_vkCopyImageToImage vkCopyImageToImage = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CopyImageToImage(VkDevice device, const VkCopyImageToImageInfo* pCopyImageToImageInfo) const noexcept;
#endif
    
#if defined(VKIT_API_VERSION_1_4)
    PFN_vkTransitionImageLayout vkTransitionImageLayout = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult TransitionImageLayout(VkDevice device, uint32_t transitionCount, const VkHostImageLayoutTransitionInfo* pTransitions) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateVideoSessionKHR(VkDevice device, const VkVideoSessionCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkVideoSessionKHR* pVideoSession) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateVideoSessionParametersKHR(VkDevice device, const VkVideoSessionParametersCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkVideoSessionParametersKHR* pVideoSessionParameters) const noexcept;
#endif
    
#if defined(VK_KHR_video_queue)
    PFN_vkUpdateVideoSessionParametersKHR vkUpdateVideoSessionParametersKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult UpdateVideoSessionParametersKHR(VkDevice device, VkVideoSessionParametersKHR videoSessionParameters, const VkVideoSessionParametersUpdateInfoKHR* pUpdateInfo) const noexcept;
#endif
    
#if defined(VK_KHR_video_encode_queue)
    PFN_vkGetEncodedVideoSessionParametersKHR vkGetEncodedVideoSessionParametersKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetEncodedVideoSessionParametersKHR(VkDevice device, const VkVideoEncodeSessionParametersGetInfoKHR* pVideoSessionParametersInfo, VkVideoEncodeSessionParametersFeedbackInfoKHR* pFeedbackInfo, size_t* pDataSize, void* pData) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetVideoSessionMemoryRequirementsKHR(VkDevice device, VkVideoSessionKHR videoSession, uint32_t* pMemoryRequirementsCount, VkVideoSessionMemoryRequirementsKHR* pMemoryRequirements) const noexcept;
#endif
    
#if defined(VK_KHR_video_queue)
    PFN_vkBindVideoSessionMemoryKHR vkBindVideoSessionMemoryKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult BindVideoSessionMemoryKHR(VkDevice device, VkVideoSessionKHR videoSession, uint32_t bindSessionMemoryInfoCount, const VkBindVideoSessionMemoryInfoKHR* pBindSessionMemoryInfos) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateCuModuleNVX(VkDevice device, const VkCuModuleCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkCuModuleNVX* pModule) const noexcept;
#endif
    
#if defined(VK_NVX_binary_import)
    PFN_vkCreateCuFunctionNVX vkCreateCuFunctionNVX = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateCuFunctionNVX(VkDevice device, const VkCuFunctionCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkCuFunctionNVX* pFunction) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetBufferOpaqueCaptureDescriptorDataEXT(VkDevice device, const VkBufferCaptureDescriptorDataInfoEXT* pInfo, void* pData) const noexcept;
#endif
    
#if defined(VK_EXT_descriptor_buffer)
    PFN_vkGetImageOpaqueCaptureDescriptorDataEXT vkGetImageOpaqueCaptureDescriptorDataEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetImageOpaqueCaptureDescriptorDataEXT(VkDevice device, const VkImageCaptureDescriptorDataInfoEXT* pInfo, void* pData) const noexcept;
#endif
    
#if defined(VK_EXT_descriptor_buffer)
    PFN_vkGetImageViewOpaqueCaptureDescriptorDataEXT vkGetImageViewOpaqueCaptureDescriptorDataEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetImageViewOpaqueCaptureDescriptorDataEXT(VkDevice device, const VkImageViewCaptureDescriptorDataInfoEXT* pInfo, void* pData) const noexcept;
#endif
    
#if defined(VK_EXT_descriptor_buffer)
    PFN_vkGetSamplerOpaqueCaptureDescriptorDataEXT vkGetSamplerOpaqueCaptureDescriptorDataEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetSamplerOpaqueCaptureDescriptorDataEXT(VkDevice device, const VkSamplerCaptureDescriptorDataInfoEXT* pInfo, void* pData) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetAccelerationStructureOpaqueCaptureDescriptorDataEXT(VkDevice device, const VkAccelerationStructureCaptureDescriptorDataInfoEXT* pInfo, void* pData) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult WaitForPresentKHR(VkDevice device, VkSwapchainKHR swapchain, uint64_t presentId, uint64_t timeout) const noexcept;
#endif
    
#if defined(VK_FUCHSIA_buffer_collection)
    PFN_vkCreateBufferCollectionFUCHSIA vkCreateBufferCollectionFUCHSIA = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateBufferCollectionFUCHSIA(VkDevice device, const VkBufferCollectionCreateInfoFUCHSIA* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkBufferCollectionFUCHSIA* pCollection) const noexcept;
#endif
    
#if defined(VK_FUCHSIA_buffer_collection)
    PFN_vkSetBufferCollectionBufferConstraintsFUCHSIA vkSetBufferCollectionBufferConstraintsFUCHSIA = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult SetBufferCollectionBufferConstraintsFUCHSIA(VkDevice device, VkBufferCollectionFUCHSIA collection, const VkBufferConstraintsInfoFUCHSIA* pBufferConstraintsInfo) const noexcept;
#endif
    
#if defined(VK_FUCHSIA_buffer_collection)
    PFN_vkSetBufferCollectionImageConstraintsFUCHSIA vkSetBufferCollectionImageConstraintsFUCHSIA = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult SetBufferCollectionImageConstraintsFUCHSIA(VkDevice device, VkBufferCollectionFUCHSIA collection, const VkImageConstraintsInfoFUCHSIA* pImageConstraintsInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetBufferCollectionPropertiesFUCHSIA(VkDevice device, VkBufferCollectionFUCHSIA collection, VkBufferCollectionPropertiesFUCHSIA* pProperties) const noexcept;
#endif
    
#if defined(VK_NV_cuda_kernel_launch)
    PFN_vkCreateCudaModuleNV vkCreateCudaModuleNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateCudaModuleNV(VkDevice device, const VkCudaModuleCreateInfoNV* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkCudaModuleNV* pModule) const noexcept;
#endif
    
#if defined(VK_NV_cuda_kernel_launch)
    PFN_vkGetCudaModuleCacheNV vkGetCudaModuleCacheNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetCudaModuleCacheNV(VkDevice device, VkCudaModuleNV module, size_t* pCacheSize, void* pCacheData) const noexcept;
#endif
    
#if defined(VK_NV_cuda_kernel_launch)
    PFN_vkCreateCudaFunctionNV vkCreateCudaFunctionNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateCudaFunctionNV(VkDevice device, const VkCudaFunctionCreateInfoNV* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkCudaFunctionNV* pFunction) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateMicromapEXT(VkDevice device, const VkMicromapCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkMicromapEXT* pMicromap) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult BuildMicromapsEXT(VkDevice device, VkDeferredOperationKHR deferredOperation, uint32_t infoCount, const VkMicromapBuildInfoEXT* pInfos) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CopyMicromapEXT(VkDevice device, VkDeferredOperationKHR deferredOperation, const VkCopyMicromapInfoEXT* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CopyMicromapToMemoryEXT(VkDevice device, VkDeferredOperationKHR deferredOperation, const VkCopyMicromapToMemoryInfoEXT* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CopyMemoryToMicromapEXT(VkDevice device, VkDeferredOperationKHR deferredOperation, const VkCopyMemoryToMicromapInfoEXT* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult WriteMicromapsPropertiesEXT(VkDevice device, uint32_t micromapCount, const VkMicromapEXT* pMicromaps, VkQueryType queryType, size_t dataSize, void* pData, size_t stride) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetPipelinePropertiesEXT(VkDevice device, const VkPipelineInfoEXT* pPipelineInfo, VkBaseOutStructure* pPipelineProperties) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetFramebufferTilePropertiesQCOM(VkDevice device, VkFramebuffer framebuffer, uint32_t* pPropertiesCount, VkTilePropertiesQCOM* pProperties) const noexcept;
#endif
    
#if defined(VK_QCOM_tile_properties)
    PFN_vkGetDynamicRenderingTilePropertiesQCOM vkGetDynamicRenderingTilePropertiesQCOM = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetDynamicRenderingTilePropertiesQCOM(VkDevice device, const VkRenderingInfo* pRenderingInfo, VkTilePropertiesQCOM* pProperties) const noexcept;
#endif
    
#if defined(VK_NV_optical_flow)
    PFN_vkCreateOpticalFlowSessionNV vkCreateOpticalFlowSessionNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateOpticalFlowSessionNV(VkDevice device, const VkOpticalFlowSessionCreateInfoNV* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkOpticalFlowSessionNV* pSession) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult BindOpticalFlowSessionImageNV(VkDevice device, VkOpticalFlowSessionNV session, VkOpticalFlowSessionBindingPointNV bindingPoint, VkImageView view, VkImageLayout layout) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetDeviceFaultInfoEXT(VkDevice device, VkDeviceFaultCountsEXT* pFaultCounts, VkDeviceFaultInfoEXT* pFaultInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult ReleaseSwapchainImagesEXT(VkDevice device, const VkReleaseSwapchainImagesInfoEXT* pReleaseInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult MapMemory2(VkDevice device, const VkMemoryMapInfo* pMemoryMapInfo, void** ppData) const noexcept;
#endif
    
#if defined(VKIT_API_VERSION_1_4)
    PFN_vkUnmapMemory2 vkUnmapMemory2 = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult UnmapMemory2(VkDevice device, const VkMemoryUnmapInfo* pMemoryUnmapInfo) const noexcept;
#endif
    
#if defined(VK_EXT_shader_object)
    PFN_vkCreateShadersEXT vkCreateShadersEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateShadersEXT(VkDevice device, uint32_t createInfoCount, const VkShaderCreateInfoEXT* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkShaderEXT* pShaders) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetShaderBinaryDataEXT(VkDevice device, VkShaderEXT shader, size_t* pDataSize, void* pData) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetScreenBufferPropertiesQNX(VkDevice device, const struct _screen_buffer* buffer, VkScreenBufferPropertiesQNX* pProperties) const noexcept;
#endif
    
#if defined(VK_AMDX_shader_enqueue)
    PFN_vkGetExecutionGraphPipelineScratchSizeAMDX vkGetExecutionGraphPipelineScratchSizeAMDX = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetExecutionGraphPipelineScratchSizeAMDX(VkDevice device, VkPipeline executionGraph, VkExecutionGraphPipelineScratchSizeAMDX* pSizeInfo) const noexcept;
#endif
    
#if defined(VK_AMDX_shader_enqueue)
    PFN_vkGetExecutionGraphPipelineNodeIndexAMDX vkGetExecutionGraphPipelineNodeIndexAMDX = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetExecutionGraphPipelineNodeIndexAMDX(VkDevice device, VkPipeline executionGraph, const VkPipelineShaderStageNodeCreateInfoAMDX* pNodeInfo, uint32_t* pNodeIndex) const noexcept;
#endif
    
#if defined(VK_AMDX_shader_enqueue)
    PFN_vkCreateExecutionGraphPipelinesAMDX vkCreateExecutionGraphPipelinesAMDX = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateExecutionGraphPipelinesAMDX(VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkExecutionGraphPipelineCreateInfoAMDX* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult SetLatencySleepModeNV(VkDevice device, VkSwapchainKHR swapchain, const VkLatencySleepModeInfoNV* pSleepModeInfo) const noexcept;
#endif
    
#if defined(VK_NV_low_latency2)
    PFN_vkLatencySleepNV vkLatencySleepNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult LatencySleepNV(VkDevice device, VkSwapchainKHR swapchain, const VkLatencySleepInfoNV* pSleepInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetMemoryMetalHandleEXT(VkDevice device, const VkMemoryGetMetalHandleInfoEXT* pGetMetalHandleInfo, void** pHandle) const noexcept;
#endif
    
#if defined(VK_EXT_external_memory_metal)
    PFN_vkGetMemoryMetalHandlePropertiesEXT vkGetMemoryMetalHandlePropertiesEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult GetMemoryMetalHandlePropertiesEXT(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, const void* pHandle, VkMemoryMetalHandlePropertiesEXT* pMemoryMetalHandleProperties) const noexcept;
#endif
    
#if defined(VK_NV_cooperative_vector)
    PFN_vkConvertCooperativeVectorMatrixNV vkConvertCooperativeVectorMatrixNV = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult ConvertCooperativeVectorMatrixNV(VkDevice device, const VkConvertCooperativeVectorMatrixInfoNV* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateExternalComputeQueueNV(VkDevice device, const VkExternalComputeQueueCreateInfoNV* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkExternalComputeQueueNV* pExternalQueue) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult BindBufferMemory2KHR(VkDevice device, uint32_t bindInfoCount, const VkBindBufferMemoryInfoKHR* pBindInfos) const noexcept;
#endif
    
#if defined(VK_KHR_bind_memory2)
    PFN_vkBindImageMemory2KHR vkBindImageMemory2KHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult BindImageMemory2KHR(VkDevice device, uint32_t bindInfoCount, const VkBindImageMemoryInfoKHR* pBindInfos) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateDescriptorUpdateTemplateKHR(VkDevice device, const VkDescriptorUpdateTemplateCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDescriptorUpdateTemplateKHR* pDescriptorUpdateTemplate) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreateSamplerYcbcrConversionKHR(VkDevice device, const VkSamplerYcbcrConversionCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSamplerYcbcrConversionKHR* pYcbcrConversion) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetCalibratedTimestampsEXT(VkDevice device, uint32_t timestampCount, const VkCalibratedTimestampInfoEXT* pTimestampInfos, uint64_t* pTimestamps, uint64_t* pMaxDeviation) const noexcept;
#endif
    
#if defined(VK_KHR_create_renderpass2)
    PFN_vkCreateRenderPass2KHR vkCreateRenderPass2KHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CreateRenderPass2KHR(VkDevice device, const VkRenderPassCreateInfo2KHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetSemaphoreCounterValueKHR(VkDevice device, VkSemaphore semaphore, uint64_t* pValue) const noexcept;
#endif
    
#if defined(VK_KHR_timeline_semaphore)
    PFN_vkWaitSemaphoresKHR vkWaitSemaphoresKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult WaitSemaphoresKHR(VkDevice device, const VkSemaphoreWaitInfoKHR* pWaitInfo, uint64_t timeout) const noexcept;
#endif
    
#if defined(VK_KHR_timeline_semaphore)
    PFN_vkSignalSemaphoreKHR vkSignalSemaphoreKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult SignalSemaphoreKHR(VkDevice device, const VkSemaphoreSignalInfoKHR* pSignalInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult GetRayTracingShaderGroupHandlesNV(VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData) const noexcept;
#endif
    
#if defined(VK_KHR_buffer_device_address)
    PFN_vkGetBufferOpaqueCaptureAddressKHR vkGetBufferOpaqueCaptureAddressKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD uint64_t GetBufferOpaqueCaptureAddressKHR(VkDevice device, const VkBufferDeviceAddressInfoKHR* pInfo) const noexcept;
#endif
    
#if defined(VK_KHR_buffer_device_address)
    PFN_vkGetBufferDeviceAddressKHR vkGetBufferDeviceAddressKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkDeviceAddress GetBufferDeviceAddressKHR(VkDevice device, const VkBufferDeviceAddressInfoKHR* pInfo) const noexcept;
#endif
    
#if defined(VK_EXT_buffer_device_address)
    PFN_vkGetBufferDeviceAddressEXT vkGetBufferDeviceAddressEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkDeviceAddress GetBufferDeviceAddressEXT(VkDevice device, const VkBufferDeviceAddressInfoEXT* pInfo) const noexcept;
#endif
    
#if defined(VK_KHR_buffer_device_address)
    PFN_vkGetDeviceMemoryOpaqueCaptureAddressKHR vkGetDeviceMemoryOpaqueCaptureAddressKHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD uint64_t GetDeviceMemoryOpaqueCaptureAddressKHR(VkDevice device, const VkDeviceMemoryOpaqueCaptureAddressInfoKHR* pInfo) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CreatePrivateDataSlotEXT(VkDevice device, const VkPrivateDataSlotCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPrivateDataSlotEXT* pPrivateDataSlot) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult SetPrivateDataEXT(VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlotEXT privateDataSlot, uint64_t data) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult QueueSubmit2KHR(VkQueue queue, uint32_t submitCount, const VkSubmitInfo2KHR* pSubmits, VkFence fence) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult CopyMemoryToImageEXT(VkDevice device, const VkCopyMemoryToImageInfoEXT* pCopyMemoryToImageInfo) const noexcept;
#endif
    
#if defined(VK_EXT_host_image_copy)
    PFN_vkCopyImageToMemoryEXT vkCopyImageToMemoryEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CopyImageToMemoryEXT(VkDevice device, const VkCopyImageToMemoryInfoEXT* pCopyImageToMemoryInfo) const noexcept;
#endif
    
#if defined(VK_EXT_host_image_copy)
    PFN_vkCopyImageToImageEXT vkCopyImageToImageEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult CopyImageToImageEXT(VkDevice device, const VkCopyImageToImageInfoEXT* pCopyImageToImageInfo) const noexcept;
#endif
    
#if defined(VK_EXT_host_image_copy)
    PFN_vkTransitionImageLayoutEXT vkTransitionImageLayoutEXT = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult TransitionImageLayoutEXT(VkDevice device, uint32_t transitionCount, const VkHostImageLayoutTransitionInfoEXT* pTransitions) const noexcept;
#endif
    ...
    VKIT_LOADER_NO_DISCARD VkResult MapMemory2KHR(VkDevice device, const VkMemoryMapInfoKHR* pMemoryMapInfo, void** ppData) const noexcept;
#endif
    
#if defined(VK_KHR_map_memory2)
    PFN_vkUnmapMemory2KHR vkUnmapMemory2KHR = VK_NULL_HANDLE;
    VKIT_LOADER_NO_DISCARD VkResult UnmapMemory2KHR(VkDevice device, const VkMemoryUnmapInfoKHR* pMemoryUnmapInfo) const noexcept;
#endif
