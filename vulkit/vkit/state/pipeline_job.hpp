...
template <> class PipelineJob<GraphicsPipeline> final : public IPipelineJob<GraphicsPipeline>
{
  public:
    ...
    VKIT_NO_DISCARD static Result<PipelineJob> Create(const GraphicsPipeline &p_Pipeline, const PipelineLayout &p_Layout);
...
template <> class PipelineJob<ComputePipeline> final : public IPipelineJob<ComputePipeline>
{
  public:
    ...
    VKIT_NO_DISCARD static Result<PipelineJob> Create(const ComputePipeline &p_Pipeline, const PipelineLayout &p_Layout);
