...
#    define VKIT_LOG_VULKAN_RESULT(result)                                                                             \
        TKIT_LOG_INFO_IF(!result, "VkResult: '{}' - Message: '{}'", VKit::VkResultToString(result.Result),             \
                         result.Message)
#    define VKIT_LOG_RESULT(result)                                                                                    \
        TKIT_LOG_INFO_IF(!result, "VkResult: '{}' - Message: '{}'", VKit::VkResultToString(result.GetError().Result),  \
                         result.GetError().Message)
#else
...
#    define VKIT_WARN_VULKAN_RESULT(result)                                                                            \
        TKIT_LOG_WARNING_IF(!result, "VkResult: '{}' - Message: '{}'", VKit::VkResultToString(result.Result),          \
                            result.Message)
#    define VKIT_WARN_RESULT(result)                                                                                   \
        TKIT_LOG_WARNING_IF(!result, "VkResult: '{}' - Message: '{}'",                                                 \
