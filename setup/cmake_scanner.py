...
def parse_arguments() -> Namespace:
    ...
    This script will create/update a 'user-build.ini' and 'build.ini' file in the same directory this file lives, to be used by 'build.py' to do
    the actual building.
    """
...
create_ini("user-build.ini")
create_ini("build.ini")
